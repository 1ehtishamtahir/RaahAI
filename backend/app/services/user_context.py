...
- Education: {user.education or 'Not provided'}""")
    ...
    if docs:
        ...
        for d in docs:
            ...
            lines.append(f"- document_name_en={name}, document_type={d.document_type}, status={status}{exp}")
        parts.append("\n".join(lines))
    ...
    if vehicles:
        ...
        for v in vehicles:
            lines.append(
                f"- registration_no={v.registration_no}, vehicle_type={v.vehicle_type or 'vehicle'}, "
    ...
    if challans:
        ...
        for c in challans:
            lines.append(
                f"- vehicle={c.vehicle_plate or 'N/A'}, category={c.category}, "
                f"violation={c.violation}, amount={c.amount}, "
    ...
    if payments:
        ...
        for p in payments:
            lines.append(
                f"- title_en={p.title_en or p.type}, amount={p.amount}, "
    ...
    if family:
        ...
        for m in family:
            lines.append(
                f"- name={m.name}, relation={m.relation}, age={m.age}, "
    ...
    if programs:
        ...
        for p in programs:
            lines.append(
                f"- program_name={p.program_name}, member={p.member_name}, "
    ...
    if checklists:
        ...
        for cl in checklists:
            ...
            lines.append(f"- service={cl.service}, progress={done}/{total} steps completed")
        parts.append("\n".join(lines))
